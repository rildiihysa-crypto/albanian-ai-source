...
import { PUBLIC_SITE, PUBLIC_WWW } from "../site";
...
const CUSTOM_HOSTS: string[] = ["www.albanianai.it", "albanianai.it", "blend-prism-swift-garden.grok.me"];
const baseURL = {
  allowedHosts: [...previewAllowedHosts, "localhost", "127.0.0.1", "[::1]", ...CUSTOM_HOSTS],
...
const CUSTOM_APP_ORIGINS: string[] = [
  PUBLIC_WWW,
  PUBLIC_SITE,
  "https://blend-prism-swift-garden.grok.me",
];
